  ...
  return (
    <>
      ...
      <section className="bg-white px-4">
        ...
        <div
          className="rounded-[58px] overflow-hidden w-full bg-gradient-to-br from-yellow-200 via-pink-200 to-purple-300 px-7 py-10 md:py-16"
          ...
          <div className="flex flex-col md:flex-row items-center justify-between max-w-7xl mx-auto">
            ...
            <div className="w-full lg:w-2/3 mb-0 md:mb-0">
              ...
              <div className="flex flex-row items-center justify-between lg:hidden">
                <h1 className="text-3xl sm:text-5xl font-extrabold leading-none text-gray-900 w-2/3 mb-5">
              ...
              <h1 className="hidden lg:block text-5xl lg:text-6xl font-extrabold leading-tight mb-6 text-gray-900">
              ...
              <p className="mb-8 text-gray-800 max-w-xl">
                Starting at <span className="text-2xl md:text-3xl"><strong>$147</strong></span> - Compounded{' '}
                <strong>Semaglutide</strong> (Ozempic®) & <strong>Tirzepatide</strong> (Mounjaro®) in stock
              </p>
